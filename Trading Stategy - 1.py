    ...
    for j in range(1,i):
        ...
        for k in range(len(df_matching) - start):
            ...
            if signal >= upper_signal:
                ...
                buy_points.append(start) # append buy point regardless
            ...
            # Decaying the signal
            weekday, budget, added = advance_day(weekday, budget, added)
...
f = open(f'Pattern Matching Results - {signal_list}.txt', 'w')
